...
<div class="row my-5">
	<div class="col">
		...
		<div class="row mb-5 d-flex align-items-center">
			...
			<form class="row g-3" action="actions/editarEditorial.php" method="POST" enctype="multipart/form-data">
				...
				<div class="col-md-6 mb-3">
					...
					<option value="" disabled>Elegir opción</option>
						<option value="Estados Unidos" <?= $editorial->getIdEditorial() == 'Estados Unidos' ? 'selected' : '' ?>>Estados Unidos</option>
						<option value="Japón" <?= $editorial->getIdEditorial() == 'Japón' ? 'selected' : '' ?>>Japón</option>
						<option value="Reino Unido" <?= $editorial->getIdEditorial() == 'Reino Unido' ? 'selected' : '' ?>>
							Reino Unido</option>
						<option value="Francia" <?= $editorial->getIdEditorial() == 'Francia' ? 'selected' : '' ?>>Francia
						</option>
					</select>
				</div>
