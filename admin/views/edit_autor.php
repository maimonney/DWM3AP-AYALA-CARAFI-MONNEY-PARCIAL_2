        ...
        <div class="row mb-5 d-flex align-items-center">
            <form class="row g-3" action="actions/editarAutor.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre_autor"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="biografia" name="biografia_autor"
                        value="<?= htmlspecialchars($autor->getBiografia()) ?>" required>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="nacimiento" class="form-label">Fecha de nacimiento</label>
                    <input type="date" class="form-control" id="nacimiento" name="nacimiento_autor"
