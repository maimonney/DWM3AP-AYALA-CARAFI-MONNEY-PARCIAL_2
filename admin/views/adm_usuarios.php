                ...
                <tbody>
                    <?php foreach ($usuarios as $usuario) {
                        ...
                        <tr>
                            ...
                            <td>
                            <?= htmlspecialchars($usuario->getRoles()) ?>
                            <?php if ($usuario->getRoles() === "usuario") { ?>
                                    <a href="index.php?sec=adm_carrito&id=<?= $usuario->getId() ?>" class="d-block btn  mb-1" style="width:100px">Historial</a>
                                <?php } ?>
                          
                            </td>
                            <td>
                                <a href="index.php?sec=edit_usuario&id=<?= htmlspecialchars($usuario->getId()) ?>"
                                    class="d-block btn btn-sm mb-1">Editar</a>
                                <a href="index.php?sec=borrar_usuario&id=<?= htmlspecialchars($usuario->getId()) ?>"
                                    class="btn btn-sm btn_eliminar">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
